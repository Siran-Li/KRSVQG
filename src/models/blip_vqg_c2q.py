...
class BLIP_VQG_C2Q(nn.Module):
    ...
    def forward(self, image, triplet, caption=None, question=None, n=None, train=True):
        ...
        if train:               
            ...
            return loss_cg + self.qg_weight*loss_qg, loss_cg, self.qg_weight*loss_qg
...
def blip_vqg_c2q(pretrained='', pre_cgmodel='', freeze_img=False, **kwargs):
