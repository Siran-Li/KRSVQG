...
def rs_caption_eval(coco_gt_root, results_file, split):
    ...
    filenames = {'val':'nwpu_val_gt.json', 'val_nwpu': 'nwpu_val_ctq_gt.json',
                 'val_kvqg':'kvqg_val_ctq_gt.json', 'val_textrs': 'textrs_val_ctq_gt.json'}    
...
def rs_question_eval(coco_gt_root, results_file, split):
    ...
    filenames = {'val_nwpu': 'nwpu_val_ctq_gt.json', 'val_kvqg':'kvqg_val_ctq_gt.json', 'val_textrs': 'textrs_val_ctq_gt.json'}    
